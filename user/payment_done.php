                    ...
                    <div class="row mb-4">
                        <div class="col text-center">
                            <div style="background: #f8f9fa; padding: 15px; border-radius: 8px;">
                                ...
                                <h4 style="color: #493d9e;">#CK<?php echo rand(10000, 99999); ?></h4>
                            </div>
                        </div>
                    </div>
                    
                    <div class="mb-4 text-center">
                        <p class="mb-1">A confirmation email has been sent to your registered email address.</p>
                        <p class="mb-0"><small>Please present your booking reference upon arrival.</small></p>
                    </div>
